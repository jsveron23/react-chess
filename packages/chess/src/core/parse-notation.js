...
/**
 * Parse notation
 * @param  {Object} params - Notation parameters
 * @param  {Object} [params.checkData] - Check state data
 * @param  {Array}  params.from - Source tiles
 * @param  {Array}  params.to - Target tiles
 * @return {String} Notation string
 */
...
const parseNotationCurried = curry(parseNotation);
export { parseNotationCurried as parseNotation };
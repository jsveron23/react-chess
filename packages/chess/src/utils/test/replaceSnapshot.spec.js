...
test('replaceCode - invalid code', (t) => {
  t.is(typeof replaceCode(), 'function');
  t.is(typeof replaceCode('bPd7'), 'function');
  t.is(typeof replaceCode('bPd7', 'bPd5'), 'function');
...
test('replaceCode - valid code', (t) => {
  // prettier-ignore
  t.deepEqual(replaceCode('bPd7', 'bPd5', Snapshot), [
    'bRa8', 'bNb8', 'bBc8', 'bQd8', 'bKe8', 'bBf8', 'bNg8', 'bRh8',
